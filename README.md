...
📱 Application Views (So Far)

The application includes the following main views:
- Register:
    A registration screen where new users can create an account by providing their basic information.
- Login:
  A login screen where registered users can access the application using their account credentials.
- Home:
